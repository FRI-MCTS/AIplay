...
#define	TOMPLAYER_AI_UCT_TOMTEST_FUNC_APPROX_NUM_INPUTS		6	//set number of weights for the function approximator or (if dual-layer perceptron) number of inputs in the net
