/*
 * @(#)emlrt.h    generated by: makeheader 5.1.5  Wed Feb  2 14:27:23 2011
 *
...
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2011A
 ...
 */
EXTERN_C void
emlrtExitTimeCleanup(struct emlrtContext *aMAInfo);
...
#define EMLRT_LOGGING_UPDATE_RANGE(v1,v2,v3) emlrtLoggingContextUpdateRange(&emlrtContextGlobal,(v1),(v2),(v3))



/*
 * MATLAB INTERNAL USE ONLY :: Log Range
 */

EXTERN_C void emlrtLoggingContextUpdateRange(struct emlrtContext *aMAInfo, const char *aFunctionName, const char *aExprName, double aValue);


/*
 * MATLAB INTERNAL USE ONLY :: Marshall Logging Info to MATLAB
 */

EXTERN_C mxArray* emlrtLoggingContextToMxArray(struct emlrtContext *aMAInfo);
...
#define EMLRTSETPARALLEL(val) { \
    emlrtContextGlobal.bParallelMode = val; \
}
